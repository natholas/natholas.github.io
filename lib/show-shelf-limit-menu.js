...
export const showShelfLimitMenu = () => {
  return new Promise(resolve => {
    values.shelfLimitMenuOpen = true
    values.shelfLimitMenuBg = createSprite('shelf-limit-bg')
    values.shelfLimitMenuBg.y = 26
    values.shelfLimitMenuSprites.push(values.shelfLimitMenuBg)
    ...
    htmlElements.shelfLimitMenuMeta.innerHTML = `
    ...
    htmlElements.shelfLimitMenuMeta.classList.add('shown')
})
}