...
export const showSelectPlantMenu = () => {
  ...
  values.addPlantMenuBg = createSprite('plant-select-menu-bg-tall')
  values.addPlantMenuBg.y = 26
  values.addPlantMenuSprites.push(values.addPlantMenuBg)

  if (values.app.view.height < values.addPlantMenuBg.height) {
    values.app.view.height = values.addPlantMenuBg.height + values.addPlantMenuBg.y
  ...
  values.addPlantMenuConfirmButton.y = 186
